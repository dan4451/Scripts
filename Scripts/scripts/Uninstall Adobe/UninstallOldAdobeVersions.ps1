...
$x42 = Get-WmiObject win32_product -Filter 'IdentifyingNumber = "{B9B60103-0A8A-456A-9BA1-608215D74EBC}"'
$x43 = Get-WmiObject win32_product -Filter 'IdentifyingNumber = "{CC24FD8C-F49D-4770-910C-8971B32E4643}"'
...
<#
IdentifyingNumber : {CC24FD8C-F49D-4770-910C-8971B32E4643}
Name              : Acrobat Pro DC 18.0 Rebuild
Vendor            : Adobe Systems Incorporated
Version           : 1.0.0000
Caption           : Acrobat Pro DC 18.0 Rebuild

IdentifyingNumber : {B9B60103-0A8A-456A-9BA1-608215D74EBC}
Name              : Acrobat Pro DC 17.0
Vendor            : Adobe Systems Incorporated
Version           : 1.0.0000
Caption           : Acrobat Pro DC 17.0
