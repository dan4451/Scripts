# Site configuration
$ApplicationName = "Microsoft Project Professional 2016 64 bit" #Name of the application
$SiteServer = "adb-its-02.ad.bridgeport.edu" #Your site server name
$SiteCode ="ADM" #Your site code
