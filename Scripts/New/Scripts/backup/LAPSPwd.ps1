...
#checks if user is adm
#if($user -like "adm.*"){start-process powershell.exe -argumentlist '-command Write-host "Checked that account running script is adm." -ForegroundColor Green; start-sleep -s 4'}
